...
def get_elements_text_and_html_by_attribute(attribute, value, html, escape_value=...): # -> Generator[tuple[str | None, Unknown], None, None]:
    """
...
def traverse_obj(obj, *paths, default=..., expected_type=..., get_all=..., casesense=..., is_user_input=..., traverse_string=...): # -> list[Unknown] | None:
    """
...
def traverse_dict(dictn, keys, casesense=...): # -> list[Unknown] | None:
    ...

def get_first(obj, keys, **kwargs): # -> list[Unknown] | None:
    ...
